...
<html>
    ...
    <body>
        ...
        <form class="grid" method="post" action="VisiteServlet" style="padding-top: 20px ;">
            <div class="row cells2">
                <div class="cell colspan">
                    <label>Nom complet <span class="fg-red">*</span></label>
                    <div class="input-control text full-size" data-role="input">
                        <input name="nom" type="text" value="${visite.nomPersonneAttendue}" required="true">
                        <input name="id" type="hidden" value="${visite.idvisite}" required="true">
                    </div>
                </div>
                <div class="cell colspan">
                    <label>Entreprise</label>
                    <div class="input-control text full-size" data-role="input">
                        <input name="entreprise" type="text" value="${visite.entreprise}">
                    </div>
                </div>
            </div>
            <div class="row cells6">
                <div class="cell colspan6">
                    <label>Motif</label>
                    <div class="input-control text full-size" data-role="input">
                        <input name="motif" type="text" value="${visite.motif}">
                    </div>
                </div>
            </div>
            <div class="row cells12">
                ...
                <div class="cell colspan3">
                    ...
                    <c:set var="now" value="${visite.heureAttendue}" />
                    <fmt:formatDate pattern="yyyy-MM-dd" value="${now}" var="dateEmission"/>
                    <fmt:formatDate pattern="HH:mm" value="${now}" var="heure"/>
                ...
                <div class="cell colspan3">
                    <label>Heure </label>
                    <div class="input-control text full-size" data-role="input">
                        <input name="heure" type="time" value="${heure}" >
                    </div>
                </div>
            </div>
            <div class="row cells6">
