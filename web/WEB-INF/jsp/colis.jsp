...
<html>
                ...
                buttons: [
                    {
                        ...
                        title: titre,
                        message: '',
                        className: 'impressionPDF bg-blue'
                    },
                    {
                        extend: 'print',
                        text: "Imprimer",
    ...
    <body >
        <div class="padding10" style="height: 450px; overflow-y: scroll">
            <h1 class="fg-blue" style="cursor: pointer; padding-left : 30px; ">Annuaire </h1>  
                ...
                <table id="example_table" class="dataTable border bordered" style="margin-bottom: 10px;">
                    ...
                    <tbody>
                        <c:forEach items="${employes}" var="e">
                            <c:if test="${true}">
                                <tr>
                                    <td class="no-wrap"><a href="#employe/${e.idemploye}">${e.noms} ${e.prenoms}</a></td>
