        ...
        <form class="grid" method="post" action="EntreeServlet" style="padding-top: 20px ;">
            <div class="row">
                <div class="cell">
                    <label style="font-size : 1.5em">
                        Confirmez-vous la présence du visiteur dans votre bureau ?
                    </label>
                    <input type="hidden" name="action" value="confirmation_entree">
            ...
            <div class="row cells6" style="padding-top: 20px;">
                <div class="cell colspan6">
                    ...
                    <input type="submit" value="Oui" class="button bg-blue fg-white">
